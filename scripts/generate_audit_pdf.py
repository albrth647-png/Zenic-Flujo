...
# Fix Sprint 4 bug #68: paths relativos + env vars con defaults.
# Override via: ZENIC_AUDIT_PDF_OUTPUT, ZENIC_AUDIT_RESULTS_FILE
_REPO_DIR = Path(__file__).resolve().parent.parent
OUTPUT = Path(os.environ.get(
    "ZENIC_AUDIT_PDF_OUTPUT",
    _REPO_DIR.parent / "download" / "Zenic-Flijo-Auditoria-Extrema.pdf",
))
OUTPUT.parent.mkdir(parents=True, exist_ok=True)
RESULTS_FILE = Path(os.environ.get(
    "ZENIC_AUDIT_RESULTS_FILE",
    _REPO_DIR.parent / "audit_results.json",
))
