...
# Fix Sprint 4 bug #68: paths relativos al repo + env vars con defaults.
# Antes eran paths absolutos hardcoded /home/z/my-project/... que no eran
# portables a otra máquina.
# Override via env vars: ZENIC_REPO_DIR, ZENIC_AUDIT_RESULTS_FILE
REPO = Path(os.environ.get("ZENIC_REPO_DIR", Path(__file__).resolve().parent.parent))
BASE_URL = os.environ.get("ZENIC_AUDIT_BASE_URL", "http://127.0.0.1:8080")
RESULTS_FILE = Path(os.environ.get("ZENIC_AUDIT_RESULTS_FILE", REPO.parent / "audit_results.json"))
