...
- `forge/references/run-ledger.md` — Protocolo Run Ledger completo
- `forge/references/sandbox.md` — Sandbox dual (filesystem + network + rlimits)
- `forge/references/gates.md` — 12 gates bilingües + SecurityScanner
- `forge/references/phases.md` — 8 fases detalladas del prompting loop
- `forge/references/examples.md` — 5 ejemplos prácticos
- `forge/references/best-practices.md` — Guía completa DO/DON'T con investigación
