...
class AgentStatus(TypedDict):
    """Estado de un agente (retorno de get_status())."""
    agent_id: str
    name: str
    state: str
...
class BaseAgent(ABC):
    ...
    def send_message(self, recipient_id: str, content: str | dict | list, message_type: str = "inform") -> AgentMessage:
    ...
    def get_context(self, key: str, default: object = None) -> object:
