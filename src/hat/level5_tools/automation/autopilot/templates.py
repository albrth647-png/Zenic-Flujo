...
TEMPLATES: list[dict] = [
        ...
        "steps": [
            {
                ...
                "params": {
                    "to": "$slot.phone_admin",
                    "text": "Nuevo lead recibido en el sistema",
                },
            },
        ],
    },
    ...
    # ── Feature 6: Templates con trigger WhatsApp ENTRANTE ──────────────
    # Antes no existía ningún workflow que se disparara cuando llega un WhatsApp.
    # Estos 3 templates hacen que WhatsApp sea canal bidireccional (entrada + salida).
    {
        ...
        "keywords_es": ["whatsapp", "lead", "captur", "entr", "nuevo", "crm"],
        "keywords_en": ["whatsapp", "lead", "captur", "inbound", "new", "crm"],
        ...
        "steps": [
            {
                ...
                "params": {
                    ...
                    "source": "whatsapp",
                    "notes": "Lead capturado automáticamente desde WhatsApp entrante: $slot.message_text",
                },
            },
            {
                "id": 2,
                ...
                "params": {
                    ...
                    "text": "¡Hola! Gracias por contactarnos. Hemos registrado tu interés. Un asesor te contactará pronto.",
                },
            },
        ],
    },
    {
        ...
        "label": "Auto-respuesta de WhatsApp (fuera de horario)",
        "description_es": "Responder automáticamente WhatsApps recibidos fuera de horario laboral",
        "description_en": "Auto-reply to WhatsApp messages received outside business hours",
        "keywords_es": ["whatsapp", "auto", "respuest", "fuera", "horario", "automatic"],
        "keywords_en": ["whatsapp", "auto", "reply", "outside", "hours", "automatic"],
        "trigger": {"type": "event", "config": {"event": "whatsapp.message.received"}},
        "steps": [
            {
                "id": 1,
                ...
                "params": {
                    "to": "$slot.sender_phone",
                    "text": "Gracias por tu mensaje. Nuestro horario de atención es Lun-Vie 9-18h. Te responderemos a la brevedad.",
                },
            },
        ],
    },
    {
        ...
        "description_es": "Cuando llega un WhatsApp, reenviarlo al admin para que lo revise",
        "description_en": "When a WhatsApp arrives, forward it to admin for review",
        "keywords_es": ["whatsapp", "admin", "notific", "avis", "reenv", "entr"],
