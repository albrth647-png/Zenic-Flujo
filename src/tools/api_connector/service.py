...
Orquestador delgado que compone: RateLimiter, ResponseCache, PaginationCollector,
WebhookCallbackRegistry, XMLProcessor y HTTP client desde submódulos.
"""
...
from src.tools.api_connector.http_client import (
    _elapsed,
    _error,
    execute_request,
    extract_items,
...
class APIConnectorService:
    ...
    La ejecución HTTP está en src/tools/api_connector/http_client.py.
    """
