...
Uso:
    from src.core.i18n import t, set_language, get_available_languages
...
from src.core.i18n.locales.en import MESSAGES as EN_MESSAGES
from src.core.i18n.locales.es import MESSAGES as ES_MESSAGES
