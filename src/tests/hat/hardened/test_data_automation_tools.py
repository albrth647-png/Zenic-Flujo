...
class TestDataTools:
    ...
    def test_data_keeper_has_save_record(self) -> None:
        ...
        assert hasattr(service, "insert") or hasattr(service, "save") or hasattr(service, "save_record")  # noqa: E501
    ...
    def test_api_connector_has_test_connector(self) -> None:
        ...
        service = APIConnectorService()
        assert hasattr(service, "request") or hasattr(service, "test_connector") or hasattr(service, "validate_url")  # noqa: E501
...
class TestAutomationTools:
    ...
    def test_code_runner_has_sandbox(self) -> None:
        ...
        assert hasattr(service, "run_python") or hasattr(service, "run") or hasattr(service, "execute")  # noqa: E501
...
class TestPaymentTools:
    ...
    def test_mercadopago_has_get_status(self) -> None:
        ...
        service = MercadoPagoService()
        assert hasattr(service, "create_payment") or hasattr(service, "create_preference") or hasattr(service, "get_status")  # noqa: E501
