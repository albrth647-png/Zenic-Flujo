...
class TestInventoryService:
    ...
    def test_list_products_low_stock_only(self, inventory_service):
        ...
        inventory_service.add_product(
            sku="LOW-001", name="Low Stock Product",
            stock=3, min_stock=10, price=5.0,
        )
        # Product with normal stock
        inventory_service.add_product(
            sku="NORMAL-001", name="Normal Stock Product",
            stock=100, min_stock=10, price=15.0,
        )
    ...
    def test_get_product_by_id(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="GET-001", name="Get Product", price=10.0,
        )
    ...
    def test_update_stock_in(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="STOCK-IN-001", name="Stock In Product",
            stock=50, price=10.0,
        )
        result = inventory_service.update_stock(
            created["id"], quantity=20, movement_type="in", reason="Recepción",
        )
    ...
    def test_update_stock_out(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="STOCK-OUT-001", name="Stock Out Product",
            stock=50, price=10.0,
        )
        result = inventory_service.update_stock(
            created["id"], quantity=15, movement_type="out", reason="Venta",
        )
    ...
    def test_update_stock_adjustment(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="STOCK-ADJ-001", name="Stock Adj Product",
            stock=50, price=10.0,
        )
        result = inventory_service.update_stock(
            created["id"], quantity=42, movement_type="adjustment", reason="Inventario físico",
        )
    ...
    def test_stock_movements_tracking(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="MOVE-001", name="Movement Product",
            stock=100, price=10.0,
        )
    ...
    def test_low_stock_detection(self, inventory_service):
        ...
        inventory_service.add_product(
            sku="DETECT-LOW-001", name="Detect Low",
            stock=5, min_stock=10, price=10.0,
        )
        # Product with stock at min_stock boundary
        inventory_service.add_product(
            sku="DETECT-BOUND-001", name="Detect Boundary",
            stock=10, min_stock=10, price=10.0,
        )
    ...
    def test_update_product_details(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="UPD-DET-001", name="Original Name",
            description="Original desc", price=10.0,
        )
    ...
    def test_delete_product(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="DEL-001", name="Delete Me", price=1.0,
        )
    ...
    def test_stock_out_does_not_go_negative(self, inventory_service):
        ...
        created = inventory_service.add_product(
            sku="NO-NEG-001", name="No Negative",
            stock=5, price=10.0,
        )
        result = inventory_service.update_stock(
            created["id"], quantity=100, movement_type="out", reason="Venta grande",
        )
    ...
    def test_get_product_by_sku(self, inventory_service):
        ...
        inventory_service.add_product(
            sku="SKU-SEARCH-001", name="SKU Search Product", price=25.0,
        )
        from src.tools.inventory.repository import InventoryRepository
        repo = InventoryRepository()
    ...
    def test_inventory_stats(self, inventory_service):
        ...
        inventory_service.add_product(
            sku="STATS-001", name="Stats Product",
            stock=50, price=10.0,
        )
    ...
    def test_default_min_stock(self, inventory_service):
        ...
        result = inventory_service.add_product(
            sku="DEFAULT-MIN-001", name="Default Min", price=5.0,
        )
    ...
    def test_default_stock_zero(self, inventory_service):
        ...
        result = inventory_service.add_product(
            sku="DEFAULT-STOCK-001", name="Default Stock", price=5.0,
        )
