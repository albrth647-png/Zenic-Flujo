    ...
    def test_subworkflow_step_executes_child(self, db_manager):
        ...
        child = repo.create(
            WorkflowDefinition(
                ...
                trigger_type="manual",
                steps=[
                    {"id": 1, "tool": "test_tool", "action": "echo", "params": {"message": "desde hijo"}},
                ],
            )
        )
    ...
    def test_subworkflow_with_input_mapping(self, db_manager):
        ...
        child = repo.create(
            WorkflowDefinition(
                ...
                trigger_type="manual",
                steps=[
                    {"id": 1, "tool": "test_tool", "action": "echo", "params": {"message": "$input.nombre"}},
                ],
            )
        )
    ...
    def test_subworkflow_nested_depth_limit(self, db_manager):
        ...
        leaf = repo.create(
            WorkflowDefinition(
                ...
                trigger_type="manual",
                steps=[
                    {"id": 1, "tool": "test_tool", "action": "echo", "params": {"message": "leaf"}},
                ],
            )
        )
    ...
    def test_subworkflow_with_output_mapping(self, db_manager):
        ...
        child = repo.create(
            WorkflowDefinition(
                ...
                trigger_type="manual",
                steps=[
                    {"id": 1, "tool": "test_tool", "action": "echo", "params": {"message": "resultado_test"}},
                ],
            )
        )
