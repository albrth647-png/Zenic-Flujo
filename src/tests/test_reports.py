...
class TestCSVReports:
    ...
    def test_generate_workflows_csv(self, db_manager, sample_workflow):
        ...
        repo.create(WorkflowDefinition(
            name="Workflow 2", trigger_type="manual", steps=[],
        ))
    ...
    def test_generate_crm_csv(self, db_manager):
        ...
        crm = CRMService()
        crm.create_lead("Juan", email="juan@test.com", phone="555-0100",
                        company="ACME", source="web")
        crm.create_lead("María", email="maria@test.com", phone="555-0200",
                        company="XYZ", source="referral")
